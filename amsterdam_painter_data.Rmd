...
```{r women_engraver}
  ...
  results_amsterdam_painter_fem = read_html("http://www.vondel.humanities.uva.nl/ecartico/persons/index.php?occupation_id=130%2C209&subjectmat=&place=Amsterdam&gender=female&year_start=1556&year_end=1725&formtype=selections&page=1&subtask=selections") #read's html of each link page
