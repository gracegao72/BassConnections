...
num_children_2_df <-data.frame()
num_children_3_df <- data.frame()
num_children_4_df <- data.frame()
...
num_children_4_df = bind_rows(num_children_4_df, rownum_tibble)
...
write_xlsx(x = num_children_4_df, path = "fourth_part_children_data.xlsx", col_names = TRUE)
