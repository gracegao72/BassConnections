...
```{r women_engraver}
  ...
  results_antwerp_painter_fem = read_html("http://www.vondel.humanities.uva.nl/ecartico/persons/index.php?occupation_id=130%2C209&subjectmat=&place=antwerpen&gender=female&year_start=1556&year_end=1725&formtype=selections&page=1&subtask=selections") #read's html of each link page
...
write_xlsx(x = results_df_antwerp_painter_fem, path = "antwerp_book_painter_data_fem.xlsx", col_names = TRUE)
```